  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg flex gap-2 justify-center">
       <div className="text-center">
        <h2 className="text-purple-400 text-2xl font-bold mb-4">Expense Analytics</h2>
        <div className="flex gap-2 justify-center">
             <button className="flex gap-2 bg-purple-300 p-2 active:scale-95 cursor-pointer rounded text-white">
            <PieChart /> Pie Chart
        </button>
